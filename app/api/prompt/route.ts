      ...
      try {
        const chatCompletion = await client.chat.completions.create({
          ...
          messages: [
            ...
            {
              role: 'user',
              content: `Create a detailed image generation prompt based on this idea: "${prompt}". The output should be a single enhanced prompt without any explanations or additional text. and ouput english.`,
            },
          ],
          temperature: 0.7,
          max_tokens: 150,
